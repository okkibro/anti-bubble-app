                ...
                this.snackBar.open(data.message, 'X', { duration: 2000, panelClass: ['style-succes'] }).afterDismissed().subscribe(() => {
                    this.milestoneUpdates.updateMilestone(milestones[2], 1).subscribe(data => {
                        if (data.completed) {
                            ...
                            this.snackBar.open('\uD83C\uDF89 Gefeliciteerd! Je hebt de badge \'Gierige Gerrie\' verdiend! \uD83C\uDF89', 'X', { duration: 4000, panelClass: ['style-succes'] });
                        }
                        this.milestoneUpdates.updateMilestone(milestones[4], 1).subscribe(data => {
                            if (data.completed) {
                                ...
                                this.snackBar.open('\uD83C\uDF89 Gefeliciteerd! Je hebt de badge \'Shoppaholic\' verdiend! \uD83C\uDF89', 'X', { duration: 4000, panelClass: ['style-succes'] });
                            }
